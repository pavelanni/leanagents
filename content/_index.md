...
{{< figure src="lean_agents_hero.png" alt="Three lean agents collaborating — analyzing data, writing code, and designing architecture" class="mx-auto max-w-2xl" nozoom=true >}}
